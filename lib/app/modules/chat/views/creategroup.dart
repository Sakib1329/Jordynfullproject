        ...
        builder: (context, constraints) {
          return Obx(() {
            final filteredNames = controller.names
                .where((name) => name.toLowerCase().contains(controller.searchQuery.value.toLowerCase()))
                .toList();
                      ...
                      if (filteredNames.isEmpty)
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => _buildUserTile(filteredNames[index]),
                          ),
                        ),
                      Spacer(),
                      Padding(
        ...
        trailing: Obx(() => GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: controller.isSelected(name)
                  ? Colors.blue
                  : Colors.transparent,
              border: Border.all(
                color: controller.isSelected(name)
